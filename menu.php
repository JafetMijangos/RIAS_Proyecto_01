    ...
    <?php
				...
				if ($bFirmado){
					...
					switch ($_SESSION["sTipoFirmado"]){
						case Actor::CLIENTE: $sClsMnCliente="menu";
											   break;
						case Actor::ADMINISTRADOR: $sClsMnAdmor="menu";
											   break;
					}
				}
	?>
...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="<?php echo ($bFirmado?"inicio.php":"index.php");?>" class="menu nav-item nav-link" id="mnuInicio">Inicio</a>			
				...
				<a href="<?php echo ($bFirmado?:"clienteReg.php");?>" class="menu nav-item nav-link" id="mnuReg">Registrarse</a>
