 ...
 *************************************************************/
 ...
 private $oConexion=null; 
		...
		$bRet = false;
			try{ 
				$this->oConexion = new PDO("mysql:host=mysql-88011-0.cloudclusters.net:10674;dbname=pasteleriadb","admin","wDY7cxCJ",array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'UTF8'")); 
